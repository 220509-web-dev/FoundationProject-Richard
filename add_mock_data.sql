...
insert into notes (name, note_body, owner_id, visible) values ('my super secret', 'meow', 1, true);
insert into notes (name, note_body, owner_id, visible) values ('super super secret', 'no one can see this :D', 2, false);